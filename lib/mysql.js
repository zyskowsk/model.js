...
MySql.prototype.execute_raw_query = function(query, callback) {
...
MySql.prototype.select_query = function(table_name, columns) {
    var insert_query = 'SELECT * FROM `{table_name}`';
